...
var userFullName;
var user_FullName;
var $userFullName; // let 2fullName; 
// let my-Name = 'asdas'; 
// let full&name
// let full name  
// let full*Name
...
function countAge() {
  ...
  var userBirthDate = prompt("Enter your age, please: ");
...
function countPerimeterSquare() {
  var sideLength = prompt("Enter the length of one side");
  alert("The perimetr of your square is ".concat(sideLength * 4));
} //Запитай у користувача радіус кола і виведи площу такої окружності.


function countCircleArea() {
  var radiusLength = prompt("Enter the length of one side");
  alert("The area of your circle is ".concat(Math.PI * Math.pow(radiusLength, 2)));
...
function countSpeed() {
  var distanceBetweenCities = prompt("Enter the distance between cities in km");
  var hoursToArrive = prompt("Enter the hours you want to get there");
  alert("The area of your circle is ".concat(distanceBetweenCities / hoursToArrive));
...
function convertorUSD_EUR() {
  var ratio = 0.85;
  var amountToConvert = prompt("Enter the amount you want to convert");
  alert("The area of your circle is ".concat(amountToConvert * ratio));
}